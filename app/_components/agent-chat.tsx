...
const AGENT_NAME = "Mgr Alfredo Delgadillo Cossio";
...
export function AgentChat({ children }: { children?: ReactNode }) {
  ...
  const composer = (
    <PromptInput onSubmit={handleSubmit}>
      <PromptInputTextarea placeholder="Pregunte por una unidad, un ejercicio o una fórmula…" />
      ...
      >
        {isEmpty ? (
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <h1 className="max-w-xl font-serif text-4xl font-medium tracking-tight sm:text-5xl">
